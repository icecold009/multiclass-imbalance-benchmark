...
| PILOT-01 | Run the representative Stage 0 pilot across numeric, mixed, low-support, and larger/high-dimensional datasets. | [>] Current | CMC completed 330 valid cells and 165 explicit applicability failures in 130.7 seconds; Glass completed 375 valid cells and 120 explicit failures in 102.2 seconds; letter exceeded the 900-second run limit without final artifacts; yeast was interrupted before results. Complete the remaining low-support pilot evidence and resolve the runtime budget before scope lock. |
